                    ...
                    <div class="modal-dialog">
                        <div class="modal-content" style="background-color:rgb(195, 223, 195)">
                            ...
                            <div class="modal-body">
                                Are you willing to commit to this volunteer event and follow the program until its
                                completion?
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" style="background-color: rgb(172, 172, 172); border:none; width:70px; margin-right:10px">No</button>
                                <form action="/regEvent" method="POST">
                                    @csrf
                                    <input type="text" name="id" id="id" value="{{ $event->id }}" hidden>
                                    <button type="submit" value="submit" class="btn btn-success"
                                        style="color: white; width:70px">Yes</button>
                                </form>
                            </div>
                        </div>
                    </div>
