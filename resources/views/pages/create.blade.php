                    ...
                    <div class="card-body p-5">
                        <form action="/newEvent" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" name="organizer" placeholder="Event Organizer">
                                        <label>Event Organizer</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="email" class="form-control" name="orgEmail" placeholder="Organizer Email">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" name="quota" placeholder="Number of Volunteers" min="1">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" name="note" placeholder="Special Notes (Optional)">
